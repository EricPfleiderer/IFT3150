...
# Self play
EPISODES = 3  # Number of clinical trials performed every iteration (fill memory).
MCTS_SIMS = 5  # Number of Monte Carlo simulations before acting on the environment.
MEMORY_SIZE = 20  # Number of states needed in memory before refitting.
...
# Evaluation
EVAL_EPISODES = 3  # Number of clinical trials performed every iteration (evaluate agents).
...
TREATMENT_LEN = 20  # Treatment length in days
